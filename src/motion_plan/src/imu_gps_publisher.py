...
class sensor_data_pub():
    ...
    def publish_gps(self):
        ...
        self.gps.position_covariance = [1e-3, 1e-3, 1e-3, 1e-3, 1e-3, 1e-3, 1e-3, 1e-3, 1e-3]
        self.gps.status = NavSatStatus(status=NavSatStatus.STATUS_SBAS_FIX, service=NavSatStatus.SERVICE_GPS)
